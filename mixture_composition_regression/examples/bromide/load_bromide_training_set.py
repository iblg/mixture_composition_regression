...
def load_training_set(filepaths=[None, None, None]):
    ...
    df = clean_data(file, dropna='any')

    water1 = Sample('water1', df, 0, 1, chem_properties=cp, w=[1., 0., 0.], background=back)

    dipa1 = Sample('dipa1', df, 4, 5, chem_properties=cp, w=[0., 1., 0.], background=water1)
