...
def import_training_set():
    ...
    # 03-30-2023 data
    file = '/Users/ianbillinge/Documents/yiplab/programming/uvvisnir/1mm_pl/2023-03-30/2023-03-30.csv'
    df = clean_data(file)
    ...
    nacl_005_6b = Sample('dipa_nacl_005_6b', df, 10, 11, chem_properties=cp, w=get_005_w(0.3404, 6.3267), background=None)
    nacl_005_2a = Sample('dipa_nacl_005_2a', df, 12, 13, chem_properties=cp, w=get_005_w(4.6713, 1.6821), background=None)
    nacl_005_2b = Sample('dipa_nacl_005_2b', df, 14, 15, chem_properties=cp, w=get_005_w(4.6713, 1.6821), background=None)
    nacl_005_5a = Sample('dipa_nacl_005_5a', df, 16, 17, chem_properties=cp, w=get_005_w(0.4695, 5.5782), background=None)
    nacl_005_5b = Sample('dipa_nacl_005_5b', df, 18, 19, chem_properties=cp, w=get_005_w(0.4695, 5.5782), background=None)
    nacl_005_4a = Sample('dipa_nacl_005_4a', df, 20, 21, chem_properties=cp, w=get_005_w(1.1842, 3.6719), background=None)
    nacl_005_4b = Sample('dipa_nacl_005_4b', df, 22, 23, chem_properties=cp, w=get_005_w(1.1842, 3.6719), background=None)
    nacl_005_3a = Sample('dipa_nacl_005_3a', df, 24, 25, chem_properties=cp, w=get_005_w(2.1407, 2.9448), background=None)

    m1 = Mixture([water1, dipa1, water2, water3, dipa2, dipa_w1, dipa_w1a, dipa_w2, dipa_w2a, dipa_w3, dipa_w4,
                  five_M, five_M_2, two_M, two_M_2, four_M, four_M_2, nacl_005_1a, nacl_005_1b,nacl_005_2a, nacl_005_2b,
